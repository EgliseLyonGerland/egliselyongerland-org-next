...
export enum MediaItemSizeEnum {
  ...
  Profile_48 = "PROFILE_48",
  /** MediaItem with the profile_96 size */
  Profile_96 = "PROFILE_96",
  /** MediaItem with the profile_150 size */
  Profile_150 = "PROFILE_150",
  /** MediaItem with the profile_300 size */
  Profile_300 = "PROFILE_300",
...
export type Post = ContentNode &
  ...
  UniformResourceIdentifiable & {
    ...
    /** Connection between the ContentNode type and the EnqueuedStylesheet type */
    enqueuedStylesheets: Maybe<ContentNodeToEnqueuedStylesheetConnection>;
    /** Added to the GraphQL Schema because the ACF Field Group &quot;Informations sur l&#039;évènement&quot; was set to Show in GraphQL. */
    event: Maybe<Post_Event>;
    /** The excerpt of the post. */
    excerpt: Maybe<Scalars["String"]>;
    /** Connection between the NodeWithFeaturedImage type and the MediaItem type */
    featuredImage: Maybe<NodeWithFeaturedImageToMediaItemConnectionEdge>;
    ...
    id: Scalars["ID"];
    /** Added to the GraphQL Schema because the ACF Field Group &quot;Informations complémentaires&quot; was set to Show in GraphQL. */
    infos: Maybe<Post_Infos>;
    /** Whether the node is a Content Node */
    isContentNode: Scalars["Boolean"];
    /** Whether the object is a node in the preview state */
    isPreview: Maybe<Scalars["Boolean"]>;
...
/** Field Group */
export type Post_Event = AcfFieldGroup & {
  __typename?: "Post_Event";
  audioId: Maybe<MediaItem>;
  /** The name of the ACF Field Group */
  fieldGroupName: Maybe<Scalars["String"]>;
  /** Date à laquelle à eu lieu la prédication */
  sermonDate: Maybe<Scalars["String"]>;
  youtubeUrl: Maybe<Scalars["String"]>;
};

/** Field Group */
export type Post_Infos = AcfFieldGroup & {
  __typename?: "Post_Infos";
  /** The name of the ACF Field Group */
  fieldGroupName: Maybe<Scalars["String"]>;
  /**
   * Listez la ou les références bibliques auxquelles l&#039;article se réfère.
   * &lt;br /&gt;
   * &lt;br /&gt;&lt;strong&gt;Formats autorisés :&lt;/strong&gt;
   * &lt;br /&gt;
   * &lt;ul&gt;
   *   &lt;li&gt;
   *     &lt;b&gt;Un livre :&lt;/b&gt;
   *     &lt;br /&gt;- Format : &lt;code&gt;&lt;livre&gt;&lt;/code&gt;
   *     &lt;br /&gt;- Exemple : &quot;1 Pierre&quot;
   *     &lt;br /&gt;&nbsp;
   *   &lt;/li&gt;
   *   &lt;li&gt;
   *     &lt;b&gt;Un chapitre :&lt;/b&gt;
   *     &lt;br /&gt;- Format : &lt;code&gt;&lt;livre&gt; &lt;chapitre&gt;&lt;/code&gt;
   *     &lt;br /&gt;- Exemple : &quot;1 Pierre 3&quot;
   *     &lt;br /&gt;&nbsp;
   *   &lt;/li&gt;
   *   &lt;li&gt;
   *     &lt;b&gt;Une succession de plusieurs chapitres :&lt;/b&gt;
   *     &lt;br /&gt;- Format : &lt;code&gt;&lt;livre&gt; &lt;chapitre_début&gt;-&lt;chapitre_fin&gt;&lt;/code&gt;
   *     &lt;br /&gt;- Exemple : &quot;1 Pierre 3-5&quot;
   *     &lt;br /&gt;&nbsp;
   *   &lt;/li&gt;
   *   &lt;li&gt;
   *     &lt;b&gt;Un verset :&lt;/b&gt;
   *     &lt;br /&gt;- Format : &lt;code&gt;&lt;livre&gt; &lt;chapitre&gt;.&lt;verset&gt;&lt;/code&gt;
   *     &lt;br /&gt;- Exemple : &quot;1 Pierre 3.4&quot;
   *     &lt;br /&gt;&nbsp;
   *   &lt;/li&gt;
   *   &lt;li&gt;
   *     &lt;b&gt;Une succession de plusieurs versets au sein d&#039;un chapitre :&lt;/b&gt;
   *     &lt;br /&gt;- Format : &lt;code&gt;&lt;livre&gt; &lt;chapitre&gt;.&lt;verset_début&gt;-&lt;verset_fin&gt;&lt;/code&gt;
   *     &lt;br /&gt;- Exemple : &quot;1 Pierre 3.4-13&quot;
   *     &lt;br /&gt;&nbsp;
   *   &lt;/li&gt;
   *   &lt;li&gt;
   *     &lt;b&gt;Une succession de plusieurs versets au travers de plusieurs chapitres :&lt;/b&gt;
   *     &lt;br /&gt;- Format : &lt;code&gt;&lt;livre&gt; &lt;chapitre_début&gt;.&lt;verset_début&gt;-&lt;chapitre_fin&gt;.&lt;verset_fin&gt;&lt;/code&gt;
   *     &lt;br /&gt;- Exemple : &quot;1 Pierre 3.4-5.13&quot;
   *     &lt;br /&gt;&nbsp;
   *   &lt;/li&gt;
   * &lt;/ul&gt;
   */
...
export type GetPagesQuery = {
  ...
  pages: {
    __typename?: "RootQueryToPageConnection";
    nodes: Array<{ __typename?: "Page"; slug: string }>;
  };
};
